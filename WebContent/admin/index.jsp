			...
			<div class="menu_dropdown bk_2">
				<dl id="menu-article">
					...
					<dd>
						<ul>
							<li>
								<a _href="folder-list.jsp" data-title="栏目管理" href="javascript:void(0)">栏目管理</a>
							</li>
							<li>
								<a _href="article-list.jsp" data-title="资讯管理" href="javascript:void(0)">资讯管理</a>
							</li>
						</ul>
					</dd>
				</dl>
				<dl id="menu-picture">
					...
					<dd>
						<ul>
							<li>
								<a _href="file-list.jsp" data-title="文件管理" href="javascript:void(0)">文件管理</a>
							</li>
						</ul>
					</dd>
				</dl>
				<dl id="menu-comments">
					...
					<dd>
						<ul>
							<li>
								<a _href="comment-list.jsp" data-title="评论管理" href="javascript:;">评论管理</a>
							</li>
							<li>
								<a _href="feedback-list.jsp" data-title="意见反馈管理" href="javascript:void(0)">意见反馈管理</a>
							</li>
						</ul>
					</dd>
				</dl>
				<dl id="menu-member">
					...
					<dd>
						<ul>
							<li>
								<a _href="member-list.jsp" data-title="会员列表" href="javascript:;">会员列表</a>
							</li>
							<li>
								<a _href="member-del.jsp" data-title="删除的会员" href="javascript:;">删除的会员</a>
							</li>
							<li>
								<a _href="member-level.jsp" data-title="等级管理" href="javascript:;">等级管理</a>
							</li>
							<li>
								<a _href="member-scoreoperation.jsp" data-title="积分管理" href="javascript:;">积分管理</a>
							</li>
							<li>
								<a _href="member-record-browse.jsp" data-title="浏览记录" href="javascript:void(0)">浏览记录</a>
							</li>
							<li>
								<a _href="member-record-download.jsp" data-title="下载记录" href="javascript:void(0)">下载记录</a>
							</li>
							<li>
								<a _href="member-record-share.jsp" data-title="分享记录" href="javascript:void(0)">分享记录</a>
							</li>
						</ul>
					</dd>
				</dl>
				<dl id="menu-admin">
					...
					<dd>
						<ul>
							...
							<li>
								<a _href="system-admin-list.jsp" data-title="管理员列表" href="javascript:void(0)">管理员列表</a>
							</li>
						</ul>
					</dd>
				</dl>
				<!--<dl id="menu-tongji">
					...
					<dd>
						<ul>
							<li>
								<a _href="charts-1.jsp" data-title="折线图" href="javascript:void(0)">折线图</a>
							</li>
							<li>
								<a _href="charts-2.jsp" data-title="时间轴折线图" href="javascript:void(0)">时间轴折线图</a>
							</li>
							<li>
								<a _href="charts-3.jsp" data-title="区域图" href="javascript:void(0)">区域图</a>
							</li>
							<li>
								<a _href="charts-4.jsp" data-title="柱状图" href="javascript:void(0)">柱状图</a>
							</li>
							<li>
								<a _href="charts-5.jsp" data-title="饼状图" href="javascript:void(0)">饼状图</a>
							</li>
							<li>
								<a _href="charts-6.jsp" data-title="3D柱状图" href="javascript:void(0)">3D柱状图</a>
							</li>
							<li>
								<a _href="charts-7.jsp" data-title="3D饼状图" href="javascript:void(0)">3D饼状图</a>
							</li>
						</ul>
					</dd>
				</dl>-->
				<dl id="menu-system">
					...
					<dd>
						<ul>
							...
							<li>
								<a _href="system-data.jsp" data-title="数据字典" href="javascript:void(0)">数据字典</a>
							</li>
							<li>
